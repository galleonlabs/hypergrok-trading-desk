...
4. Update the `--branch` pin in `SETUP.md` section 1 to the new tag.
...
The tag must contain a `SETUP.md` that pins to that same tag. If step 4 is skipped, the release ships instructions pointing at the previous one.
